...
// int main() {
//     S1 = CreateSemaphore(NULL, 5, INT_MAX, NULL); // khoi tao la 5
//     S2 = CreateSemaphore(NULL, 0, INT_MAX, NULL);   // khoi tao la 0
...
//             //exit(0);
//         }
//         else printf("a = %d || b = %d dung, from T1\n", na, nb);
//     }
// }
...
//             //exit(0);
//         }
//         else printf("a = %d || b = %d dung, from T2\n", na, nb);
//     }
// }
...
int main() {
    S1 = CreateSemaphore(NULL, 5, INT_MAX, NULL); // khoi tao la 5
    S2 = CreateSemaphore(NULL, 5, INT_MAX, NULL);   // khoi tao la 5
